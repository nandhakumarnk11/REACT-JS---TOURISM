...
import './App.css';
import Carousel7 from './images/chennai1.jpeg';
import Carousel55 from './images/Place.jpeg';
import Carousel8 from './images/chennai2.jpeg'; 
import Carousel9 from './images/chennai3...jpeg';
import Carousel10 from './images/chennai4.jpeg';
import Carousel56 from './images/rameshwarem1.jpeg';
import Carousel57 from './images/rameshwarem2.jpeg';
import Carousel58 from './images/Rameshwaram3.jpeg';
import Carousel59 from './images/rameshwarem4.jpeg';
import Carousel17 from './images/kodaikanal1.jpeg';
import Carousel18 from './images/kodaikanal2.jpeg';
import Carousel19 from './images/kodaikanal3..jpeg';
import Carousel20 from './images/kodaikanal4.jpeg';
import Carousel22 from './images/ooty1.jpeg';
import Carousel23 from './images/ooty2.jpeg';
import Carousel24 from './images/ooty3.jpeg';
import Carousel25 from './images/ooty4.jpeg';
import Carousel26 from './images/kanyakumari1.jpeg';
import Carousel27 from './images/kanyakumari2.jpeg';
import Carousel28 from './images/kanyakumari3.jpeg';
import Carousel29 from './images/kanyakumari4.jpeg';
import Carousel32 from './images/kumbakonam1.jpeg';
import Carousel33 from './images/kumbakonam2.jpeg';
import Carousel34 from './images/Kumbakonam3.jpeg';
import Carousel35 from './images/kumbakonam4.jpeg';
import Carousel37 from './images/madurai1..jpeg';
import Carousel38 from './images/madurai2.jpeg';
import Carousel39 from './images/madurai3..jpeg';
import Carousel40 from './images/madurai4..jpeg';
import Carousel42 from './images/yercaud1.jpeg';
import Carousel43 from './images/yercaud2.jpeg';
import Carousel44 from './images/yercaud3.jpeg';
import Carousel45 from './images/yercaud4.jpeg';
import Carousel47 from './images/theni1.jpeg';
import Carousel48 from './images/theni2.jpeg';
import Carousel49 from './images/theni13.jpeg';
import Carousel50 from './images/theni4.jpeg';
import Carousel52 from './images/hogenakkal1.jpeg';
import Carousel53 from './images/hogenakkal2..jpeg';
import Carousel54 from './images/hogenakkal3.jpeg';
import Carousel5 from './images/hokenakkal4..jpeg';
...
const Placetovisit = () => {
  return (
    <section id='Placetovisit'>
        <br></br><br></br> 
    <div className='container-fluid col-10' >
        <div className='place'>
            <img src={Carousel55} alt=''/>

        <h2>Tourist Place to Visit In TamilNadu</h2><br></br>
    
        <p className='py-2' style={{textIndent:'3rem', textAlign:'justify'}}>
Pillar Rocks of KodaikanalSourceChennai, Ooty, Pondicherry, Kodaikanal, Coimbatore, Yelagiri, Masinagudi, Conoor, Madumalai, Yercaud, Madurai, Thanjavur, Mahabalipuram, Kanyakumari, Kotagiri, Nilgiri, Krishnagiri, Auroville, Theni, Hullathy, Rameshwaram, Kalhatty Ghat and more.</p>
        <p className='py-2' style={{textIndent:'3rem', textAlign:'justify'}}>
...
<p className='py-2' style={{textIndent:'3rem', textAlign:'justify'}}>
Looking forward to visiting the most stunning places to see in Tamil Nadu?Well, then you are in for a great time. From the thriving cosmopolitan vibes of Chennai to the emerald tea plantations of Ooty and the French style houses of Pondicherry to the scenic beauty of Kodaikanal, these places will leave you overwhelmed. There is an awesome experience in store, whether you are going for leisure, backpacking or looking for an adventure.<p className='span'>Tourist Place To Visit In Tamil Nadu</p>
</p>
<p className='py-2' style={{textIndent:'3rem', textAlign:'justify'}}>
...
<div className='R2'> <br></br><br></br>
<img src={Carousel7} alt=''/>
<h4>Marine Beach, Overview</h4>
<p className='py-2' style={{textIndent:'5rem', textAlign:'justify'}}>Situated in the city of Chennai in Tamil Nadu, Marina Beach is a natural urban beach along the Bay of Bengal. The beach is stretched out to a distance of 13 kilometres making it the longest natural urban beach in the country, second largest in the world and also the most crowded beach in India with almost 30,000 visitors a day.</p>
<p className='py-2' style={{textIndent:'5rem', textAlign:'justify'}}>
With a white sandy shore that looks as though extending to infinity, the landscape of Marina Beach is a mesmerising and serene sight to behold. The beach has a primarily sandy terrain and is dotted with plenty of merry-go-rounds and shops selling souvenirs. You could take a walk along the Marina beach with your near and dear ones or even all alone and enjoy the cool evening sea along with a hot plate of crispy sundal and murukku. Watching the sun crawl upwards into the sky or even disappear into the ocean from the beach, is an awe-striking and enchanting experience.</p>
</div>


<div className='R3'> <br></br><br></br>
<img src={Carousel8} alt=''/>
<h4>MGR Flim city,Overview</h4>
<p className='py-2' style={{textIndent:'5rem', textAlign:'justify'}}>Having been established in the year 1994, a considerably new structure, the MGR Film city is managed by the Government of Tamil Nadu in loving memory of MG Ramachandran who was not only a crowd-pleasing tamil actor but also a longtime CM of Tamil Nadu.</p>
<p className='py-2' style={{textIndent:'5rem', textAlign:'justify'}}>
...
<div className='t3'> <br></br><br></br>
<img src={Carousel10} alt=''/><br></br>
<h4>Breezy Beach, Overview</h4>
<p className='py-2' style={{textIndent:'5rem', textAlign:'justify'}}>Breezy Beach lays in the remote and serene neighbourhood of Valmiki Nagar in Chennai. Being smaller and less polluted, its a perfect getaway for anyone looking for a peaceful evening.</p>
<p className='py-2' style={{textIndent:'5rem', textAlign:'justify'}}>
...
<div className='R2'> <br></br><br></br>
<img src={Carousel56} alt=''/>
<h4>Dhanushkodi Temple, Overview</h4>
<p className='py-2' style={{textIndent:'5rem', textAlign:'justify'}}>Dhanushkodi was until a few years ago a wonderful temple on the southern tip of India. However, due to a natural calamity, the cyclone, it got completely washed away.</p><p className='py-2' style={{textIndent:'5rem', textAlign:'justify'}}>
...
<div className='R3'> <br></br><br></br>
<img src={Carousel57} alt=''/><br></br>
<h4>Lakshmana Temple, Overview</h4>
<p className='py-2' style={{textIndent:'5rem', textAlign:'justify'}}>Lakshmana Tirtham had been constructed in the loving memory of Lord Lakshman, brother of Lord Rama. In order to offer sacred prayers to lord Lakshmana, this temple has been constructed in Rameshwaram itself which indicates that Lord Lakshman had been given a valuable place in the dynasty of Lord Rama.</p><p className='py-2' style={{textIndent:'5rem', textAlign:'justify'}}>
...
<div className='t3a'> <br></br><br></br>
<img src={Carousel17} alt=''/>
<h4>Green Valley View, Overview</h4>
<p className='py-2' style={{textIndent:'5rem', textAlign:'justify'}}>Formerly known as Suicide point, the Green Valley View offers a breathtaking view of the plains, deep valleys and hills. The mesmerizing view of the Vaigai Dam is an unforgettable experience. It used to be known as suicide point because of the dangerous valley which is dense and deep; below the point of more than 5000 feet drop.</p>
<p className='py-2' style={{textIndent:'5rem', textAlign:'justify'}}>
Located at a distance of 5.5 km from the Kodaikanal Lake, the Green Valley View not just offers a gorgeous view, but is also surrounded by a lot of monkeys. On the way to the point, there are several shops which offer homemade chocolates, ornaments and a wide range of flowers.</p>
</div>


<div className='R3'> <br></br><br></br>
<img src={Carousel18} alt=''/><br></br>
<h4>Kodai Lake, Overview</h4>
<p className='py-2' style={{textIndent:'5rem', textAlign:'justify'}}>Kodaikanal Lake is a manmade lake in the Kodaikanal city which is also known as Kodai Lake. Vera Levinge was the man responsible for the creativity and resources of this lake amidst Kodaikanal town. This lake was developed by the British and early missionaries from the USASA.</p>
<p className='py-2' style={{textIndent:'5rem', textAlign:'justify'}}>
...
<div className='t4a'> <br></br><br></br><br></br><br></br>
<img src={Carousel22} alt=''/>
<h4>Nilgiri Mountain Railway, Overview</h4>

<p className='py-2' style={{textIndent:'5rem', textAlign:'justify'}}>Nilgiri Mountain Railway, also known as Toy Train in Ooty, is one of the key attractions of the popular hill station Ooty. Such is the train's popularity and history that it was declared as a World Heritage Site by UNESCO in 2005. Started in the year 1899, it has continued to charm its visitors over the past many years winding its way through the best of nature.</p>

<p className='py-2' style={{textIndent:'5rem', textAlign:'justify'}}>
The Toy Train covers a distance of total 46 km in a span of 5 hours and takes one through a truly spectacular journey filled with picturesque views en route. Another fascinating feature of the train is that its youngest X-class locomotive is over 50 years old and the oldest is 80 years old.</p>
</div>


<div className='R3'> <br></br><br></br>
<img src={Carousel23} alt=''/><br></br>
<h4>Ooty Botanical Garden, Overview</h4>
<p className='py-2' style={{textIndent:'5rem', textAlign:'justify'}}>Ooty Botanical Gardens lie on the lower slopes of the Doddabetta peak, the Government Botanical Garden is a splendid garden in Udhagamandalam, near Coimbatore in the state of Tamil Nadu. Sprawled over an area of 22 hectares, the garden is divided into several sections that are trimmed beautifully to present an endearing sight.</p>
<p className='py-2' style={{textIndent:'5rem', textAlign:'justify'}}>
...
<div className='t4c'> <br></br><br></br>
<img src={Carousel24} alt=''/>
...
<div className='R3'> <br></br><br></br>
<img src={Carousel25} alt=''/><br></br>
<h4>Dolphin's Nose Overview</h4>
<p className='py-2' style={{textIndent:'5rem', textAlign:'justify'}}>Located about 12 km away from Coonoor is the Dolphin's Nose about 1,500 meters above sea level. The tip of the peak of this enormous rock resembles a dolphin's nose and this is one of the most visited tourist spots in The Nilgiris District of Tamil Nadu.</p>
<p className='py-2' style={{textIndent:'5rem', textAlign:'justify'}}>
...
<div className='R3'> <br></br><br></br>
<img src={Carousel27} alt=''/><br></br>
<h4>Vivekananda Memorial, Overview</h4>
<p className='py-2' style={{textIndent:'5rem', textAlign:'justify'}}>The magnificent Vivekananda Rock Memorial is located on a small island off Kanyakumari. It has the picturesque Indian Ocean in its backdrop. It is situated on one of the two adjacent rocks projecting out of the Lakshadweep Sea and comprises of the 'Shripada Mandapam' and the 'Vivekananda Mandapam'. Vivekananda Rock Memorial is located at about 500 meters east of the mainland of Vavathurai in Kanyakumari and can be accessed by regular ferries.</p>
<p className='py-2' style={{textIndent:'5rem', textAlign:'justify'}}>
...
<div className='t5c'> <br></br><br></br>
<img src={Carousel28} alt=''/>
<h4>Thiruvalluvar Status, Overview</h4>
<p className='py-2' style={{textIndent:'5rem', textAlign:'justify'}}>Dedicated to the accomplished philosopher and poet Thiruvalluvar, this beautiful statue finds itself on a small island near Kanyakumari. Thiruvalluvar was the author of a legendary work in the world of Literature, Tirukkural, the classic Tamil text. In his devotion, the work for the statue started in 1990 and continued till 1999, during the year in which the figure finally got completed.</p>
<p className='py-2' style={{textIndent:'5rem', textAlign:'justify'}}>
...
<div className='R3'> <br></br><br></br>
<img src={Carousel29} alt=''/><br></br>
<h4>Thirparappu Falls, Overview</h4>
<p className='py-2' style={{textIndent:'5rem', textAlign:'justify'}}>Located at a distance of about 55 kilometers from Kanyakumari, the cascading waters of the Thirparappu Falls make up for an enchanting sight. This waterfall is a manmade one and falls from a height of 50 feet. The water collects in a quaint pool below which is an ideal place to frolick around, especially for children. The falls are surrounded by thick green foliage and indigenous fauna, which make it a nature lover's paradise.</p>
<p className='py-2' style={{textIndent:'5rem', textAlign:'justify'}}>
...
<div className='R2'> <br></br><br></br>
<img src={Carousel34} alt=''/>
<h4>Adi Kumbeshwara Temple, Overview</h4>
<p className='py-2' style={{textIndent:'5rem', textAlign:'justify'}}>
Believed to have been constructed in the 7th century A.D by the Cholas, Adi Kumbeshwara Temple is one of the grandest and the oldest Shiva temple in the town. The temple has a magnificent architecture with the trademark style of the Cholas. It is dedicated to Lord Shiva and houses a unique Shiva lingam.</p>
<p className='py-2' style={{textIndent:'5rem', textAlign:'justify'}}>
The temple complex covers an area of 30,181 sq ft (2,803.9 m2) and houses four gateway towers known as gopurams. The tallest is the eastern tower, with 11 stories and a height of 128 feet (39 m) The temple has numerous shrines, with those of Kumbeswarar and Mangalambigai Amman being the most prominent. The temple complex houses many halls; the most notable is the sixteen-pillared hall built during the Vijayanagara period that has all the 27 stars and 12 zodiacs sculpted in a single stone.</p>
</div>


<div className='R3'> <br></br> <br></br>
<img src={Carousel35} alt=''/><br></br>
<h4>Airavatesvara Temple, Overview</h4>
<p className='py-2' style={{textIndent:'5rem', textAlign:'justify'}}>
...
<div className='R2'> <br></br><br></br>
<img src={Carousel42} alt=''/>
<h4>Pagoda Point, Overview</h4>
<p className='py-2' style={{textIndent:'5rem', textAlign:'justify'}}>Located in the eastern part of the Yercaud Hills, Pagoda point is a beautiful viewpoint where one is treated to a panoramic view of the entire town of Salem as well as the neighbouring village of Kakambadi. The twists and turns of the 21 hairpin bends of Yercaud can be seen from this spot as they envelop themselves around the hills. The mysterious piles of stones arranged in the form of a pyramid resembling a Pagoda give the location its unique name. These stones are believed to be placed here by local tribes.</p>
<p className='py-2' style={{textIndent:'5rem', textAlign:'justify'}}>
Between the Pagodas here lies a temple devoted to Lord Rama. One can indulge in the amazing natural beauty of the spot and the scenery of the Eastern Ghats, with the greenery growing within the rugged terrains of the hills, entwined with sights of the craggy cliffs.</p>
</div>


<div className='R3'> <br></br><br></br>
<img src={Carousel43} alt=''/><br></br>
<h4>Botanical Garden, Overview</h4>
<p className='py-2' style={{textIndent:'5rem', textAlign:'justify'}}>Any tourist who is interested in gods gift to this planet, the wondrous flora, and in knowing about various species of plants must make it a point to visit the orchid garden and the green house in the Botanical garden.</p>
<p className='py-2' style={{textIndent:'5rem', textAlign:'justify'}}>
...
<div className='t8a'> <br></br><br></br>
<img src={Carousel44} alt=''/>
<h4>Emerald Lake, Overview</h4>
<p className='py-2' style={{textIndent:'5rem', textAlign:'justify'}}>The most alluring aspect of Yercaud is its big yet natural lake very popularly known as the Emerald Lake. Surrounded by some wonderful cloud-peaked hills and a well persevered garden on its banks, this lake is a feast for the eyes.</p>
<p className='py-2' style={{textIndent:'5rem', textAlign:'justify'}}>
...
<div className='R3'> <br></br><br></br>
<img src={Carousel45} alt=''/><br></br>
<h4>Lady,s Seat, Overview</h4>
<p className='py-2' style={{textIndent:'5rem', textAlign:'justify'}}>Lady's Seat is a viewpoint that overlooks the winding ghat road and offers a spectacular view of Mettur Dam and Salem town. Besides, the place also houses a viewing tower, which is equipped with a telescope to enjoy the beautiful view. This viewing tower is open for visitors only during the daytime. Lady's Seat, Gent's Seat and Children's Seat, located to the south-west of Shevaroy Hill, are the names given to a group of rocks located on the Yercaud Hills.</p>
<p className='py-2' style={{textIndent:'5rem', textAlign:'justify'}}>
...
<div className='R2'> <br></br><br></br>
<img src={Carousel47} alt=''/>
<h4>Chinna Suruli Falls, Overview</h4>
<p className='py-2' style={{textIndent:'5rem', textAlign:'justify'}}>Located in the lap of wild, green forests, Chinna Suruli Falls is a picturesque destination to visit from Theni. It cascades all the way down from Meghamalai to form a pool of cool, sparkling water at the foothills of the mountain. Located around 54 kilometres away from the main centre, near the Kombaithozhu village, Chinna Suruli Falls is a lovely and serene destination to visit in and around Theni. It can be included in your itinerary of local sightseeing if you are visiting Theni and its nearby attractions</p>
<p className='py-2' style={{textIndent:'5rem', textAlign:'justify'}}>
Chinna Suruli Falls is one of the beautiful waterfalls near Madurai and the top visiting places in Megamalai range. It is also known as Cloudland Falls as it originates in the Megamalai Hills. In the local language, Chinna means small or younger, so in a sense, it is called the younger Suruli</p>
</div>


<div className='R3'> <br></br><br></br>
<img src={Carousel48} alt=''/><br></br>
<h4>Kumbakkarai Falls, Overview</h4>
<p className='py-2' style={{textIndent:'5rem', textAlign:'justify'}}>Located in Dindigul district near Theni in Tamil Nadu, Kumbakkarai Falls is a mesmerising waterfall that is situated at the foothills of the Kodaikanal hills. The water cascades down in two layers- at the first stage, the water collects at the rock boulders and recesses. And in the second stage, it falls down the layer of rocks. These recesses are named after wild animals like tiger, snake, elephant, cheetah etc.</p>
<p className='py-2' style={{textIndent:'5rem', textAlign:'justify'}}>
...
<div className='R2'> <br></br><br></br>
<img src={Carousel49} alt=''/>
<h4>Meghamalai, Overview</h4>
<p className='py-2' style={{textIndent:'5rem', textAlign:'justify'}}>Tucked within the Western Ghats of Tamil Nadu, Meghamalai in Theni district is the kind of hidden paradise that you read about in books, complete with exhilarating trek routes, breathtaking scenes and an excellent opportunity to take a break from your everyday life in the lap of nature.
</p>
<p className='py-2' style={{textIndent:'5rem', textAlign:'justify'}}>
The Highwavys Mountain, locally called the Meghamalai, is an undulating terrain of peaks belonging to the Varushanad Range of Western Ghats, in Theni district of Tamil Nadu. Located at an elevation of 1,500 metres above the sea level, Meghamalai is covered in the trademark green of Sahyadri, thus earning the name 'Pacha Kumachi' in Tamil, meaning 'Green Peaks'. Green peaks of Meghamalai Source Up until recently, the Meghamalai Hills were restricted to private estates of tea and coffee plantations.</p>
</div>


<div className='R3'> <br></br><br></br>
<img src={Carousel50} alt=''/><br></br>
<h4>Suruli Falls, Overview</h4>
<p className='py-2' style={{textIndent:'5rem', textAlign:'justify'}}>Suruli Falls is a beautiful waterfall in the Theni district of Tamil Nadu and one of the major tourist attractions of Theni as well. It is a perfect destination to get up close and personal with the nature and cool off in its pristine waters</p>
<p className='py-2' style={{textIndent:'5rem', textAlign:'justify'}}>
...
<div className='R2'> <br></br><br></br>
<img src={Carousel52} alt=''/>
<h4>Theerthamalai Temple, Overview</h4>
<p className='py-2' style={{textIndent:'5rem', textAlign:'justify'}}>Theerthamalai is a popular pilgrim centre close to Hogenakkal. One of its most popular destinations is the Theerthamalai temple. Lord Theerthagireeswar, a form of Lord Shiva is the worshipping deity.</p>
<p className='py-2' style={{textIndent:'5rem', textAlign:'justify'}}>
It is believed that Lord Ram worshipped Lord Shiva at this temple to absolve him of the sin of killing so many demons, after his victory over Rvana. Therefore, it is believed that a dip in these holy waters can help man rid himself of sins committed against others. Theerthamalai Temple or Theerthagiriswarar Temple is located in small village Theerthamalai, just 16 km from Harur in Dharmapuri district of Tamil Nadu. The name Theerthamalai in Tamil means hill with sacred water. The temple is situated  one km up the steep slope of the hillock, derives its name from the five springs in the temple. This temple was built during 7th Century when the Cholas and the Pandya's were ruling this dynasty.</p>
</div>


<div className='t10a'> <br></br><br></br>
<img src={Carousel53} alt=''/><br></br>
<h4>Hogenakkal Falls, Overview
</h4>
<p className='py-2' style={{textIndent:'5rem', textAlign:'justify'}}>Hogenakkal Falls is a scintillating waterfall that is located on river Kaveri in the Dharmapuri district of Tamil Nadu. The place gets its name from Hogenakkal, which means 'smoking rocks, owing to the unique rock arrangement that exists around it. The gushing beauty of this cascade is one of a kind and is often quoted as being the "Niagara falls of India".</p>
<p className='py-2' style={{textIndent:'5rem', textAlign:'justify'}}>
